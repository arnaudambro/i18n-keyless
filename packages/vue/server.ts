 ...
 *
 * Pass the result to `app.use(I18nKeyless, { lang, translations })` (or to
 * `<I18nKeylessProvider :lang :translations>`) and serialize it into the HTML so the
 * client can hydrate without a flash.
 *
