...
// Page B — DIFFERENT strings than Home, demonstrating the imperative `getTranslation(key)`
// function (for text you build dynamically, attributes, etc.) plus the `context` option.
// Navigating Home <-> About keeps everything translated.
export function About() {
  // Subscribe so this component re-renders (and getTranslation re-runs) on language change.
  useCurrentLanguage();
